...
import __Updating_Minecraft_on_PC_java_jpg from "./Updating-Minecraft-on-PC-java.jpg";
...
<Image decoding="async" width="1920" height="1280" alt="Updating Minecraft on PC java" sizes="(max-width: 1920px) 100vw, 1920px" src={__Updating_Minecraft_on_PC_java_jpg} widths={[1920, 768, 1536]} />
...
## Auto-Updates: Ensuring You Never Miss an Update
