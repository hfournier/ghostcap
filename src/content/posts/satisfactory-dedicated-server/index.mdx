...
import __SSD_VPS_Servers_Cloud_Servers_and_Cloud_Hosting_by_Vultr_Vultr_com_1_1_png from "./SSD-VPS-Servers-Cloud-Servers-and-Cloud-Hosting-by-Vultr-Vultr-com-1-1.png";
import __Deploy_Servers_Vultr_com_1_png from "./Deploy-Servers-Vultr-com-1.png";
import __Pterodactyl_png from "./Pterodactyl.png";
import __Create_a_new_custom_nest_png from "./Create-a-new-custom-nest.png";
import __Import_your_Satisfactory_Dedicated_server_egg_png from "./Import-your-Satisfactory-Dedicated-server-egg.png";
import __Start_the_game_server_instance_png from "./Start-the-game-server-instance.png";
import __Assign_ports_to_your_node_png from "./Assign-ports-to-your-node.png";
import __Assign_ports_to_your_game_server_instance_png from "./Assign-ports-to-your-game-server-instance.png";
import __Restart_your_server_png from "./Restart-your-server.png";
import __Connect_to_your_server_png from "./Connect-to-your-server.png";
...
<Image decoding="async" width="1013" height="940" alt="SSD-VPS-Servers-Cloud-Servers-and-Cloud-Hosting-by-Vultr-Vultr-com (1) (1)" sizes="(max-width: 1013px) 100vw, 1013px" src={__SSD_VPS_Servers_Cloud_Servers_and_Cloud_Hosting_by_Vultr_Vultr_com_1_1_png} widths={[1013, 768]} />
...
<Image decoding="async" width="669" height="630" alt="Deploy-Servers-Vultr-com (1)" sizes="(max-width: 669px) 100vw, 669px" src={__Deploy_Servers_Vultr_com_1_png} widths={[669, 24]} />
...
<Image decoding="async" width="1920" height="1080" alt="Create a new custom nest" sizes="(max-width: 1920px) 100vw, 1920px" src={__Create_a_new_custom_nest_png} widths={[1920, 768, 1536]} />
...
<Image decoding="async" width="1920" height="1080" alt="Import your Satisfactory Dedicated server egg" sizes="(max-width: 1920px) 100vw, 1920px" src={__Import_your_Satisfactory_Dedicated_server_egg_png} widths={[1920, 768, 1536]} />
...
<Image decoding="async" width="1920" height="1080" alt="Start the game server instance" sizes="(max-width: 1920px) 100vw, 1920px" src={__Start_the_game_server_instance_png} widths={[1920, 768, 1536]} />
...
<Image decoding="async" width="1920" height="1080" alt="Assign ports to your node" sizes="(max-width: 1920px) 100vw, 1920px" src={__Assign_ports_to_your_node_png} widths={[1920, 768, 1536]} />
...
<Image decoding="async" width="1920" height="1080" alt="Assign ports to your game server instance" sizes="(max-width: 1920px) 100vw, 1920px" src={__Assign_ports_to_your_game_server_instance_png} widths={[1920, 768, 1536]} />
...
<Image decoding="async" width="1920" height="1080" alt="Restart your server" sizes="(max-width: 1920px) 100vw, 1920px" src={__Restart_your_server_png} widths={[1920, 768, 1536]} />
...
<Image decoding="async" width="1920" height="1080" alt="Connect to your server" sizes="(max-width: 1920px) 100vw, 1920px" src={__Connect_to_your_server_png} widths={[1920, 768, 1536]} />
