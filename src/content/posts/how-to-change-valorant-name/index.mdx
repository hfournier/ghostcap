...
import __Go_To_The_Riot_Games_Account_Website_jpg from "./Go-To-The-Riot-Games-Account-Website.jpg";
import __Make_Sure_RIOT_ID_Is_Selected_jpg from "./Make-Sure-RIOT-ID-Is-Selected.jpg";
import __change_your_current_Riot_ID_and_tagline_jpg from "./change-your-current-Riot-ID-and-tagline.jpg";
import __Riot_Account_Management_save_jpg from "./Riot-Account-Management-save.jpg";
...
<Image decoding="async" width="1718" height="1262" alt="TODO: update alt text" sizes="(max-width: 1718px) 100vw, 1718px" src={__Go_To_The_Riot_Games_Account_Website_jpg} widths={[1718, 768, 1536]} />
...
<Image decoding="async" width="558" height="564" alt="Make Sure RIOT ID Is Selected" sizes="(max-width: 558px) 100vw, 558px" src={__Make_Sure_RIOT_ID_Is_Selected_jpg} widths={[558, 24, 48, 96]} />

Once logged in, choose RIOT ID on your left side of account management.

### 3\. Change your current Riot ID and tagline

<Image decoding="async" width="1701" height="1262" alt="TODO: update alt text" sizes="(max-width: 1701px) 100vw, 1701px" src={__change_your_current_Riot_ID_and_tagline_jpg} widths={[1701, 768, 1536]} />
...
<Image decoding="async" width="356" height="353" alt="TODO: update alt text" sizes="(max-width: 356px) 100vw, 356px" src={__Riot_Account_Management_save_jpg} widths={[356, 24, 48, 96, 150]} />
