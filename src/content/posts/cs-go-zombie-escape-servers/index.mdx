...
import __Ghostcap_Gaming_Website_Zombie_Escape_Server_jpg from "./Ghostcap-Gaming-Website-Zombie-Escape-Server.jpg";
import __Zombie_Escape_Server_jpg from "./Zombie-Escape-Server.jpg";
import __GFL_Clan_Zombie_Escape_jpg from "./GFL-Clan-Zombie-Escape.jpg";
import __RAZE_Join_RAZE_Zombie_Escape_Today_1_png from "./RAZE-Join-RAZE-Zombie-Escape-Today-1.png";
import __Horizon_Gaming_zombie_escape_png from "./Horizon-Gaming-zombie-escape.png";
...
<Image decoding="async" width="1280" height="720" alt="Ghostcap Gaming Website Zombie Escape Server" sizes="(max-width: 1280px) 100vw, 1280px" src={__Ghostcap_Gaming_Website_Zombie_Escape_Server_jpg} widths={[1280, 300, 1024, 768]} />
...
<Image decoding="async" width="1280" height="720" alt="Zombie-Escape Server" sizes="(max-width: 1280px) 100vw, 1280px" src={__Zombie_Escape_Server_jpg} widths={[1280, 300, 1024, 768]} />
...
<Image decoding="async" width="1280" height="720" alt="GFL Clan Zombie Escape" sizes="(max-width: 1280px) 100vw, 1280px" src={__GFL_Clan_Zombie_Escape_jpg} widths={[1280, 300, 1024, 768]} />
...
<Image decoding="async" width="1688" height="934" alt="RAZE-Join-RAZE-Zombie-Escape-Today- (1)" sizes="(max-width: 1688px) 100vw, 1688px" src={__RAZE_Join_RAZE_Zombie_Escape_Today_1_png} widths={[1688, 768, 1536]} />
...
<Image decoding="async" width="1708" height="1128" alt="Horizon Gaming zombie escape" sizes="(max-width: 1708px) 100vw, 1708px" src={__Horizon_Gaming_zombie_escape_png} widths={[1708, 768, 1536]} />
