...
<Image
  ...
  height="2017"
  alt="Pterodactyl"
  sizes="(max-width: 2937px) 100vw, 2937px"
  src={__Pterodactyl_png}
  widths={[2937, 300, 1024, 768, 1536, 2048]}
/>
...
[https://www.youtube.com/watch?v=UVDY7jv8s_0](https://www.youtube.com/watch?v=UVDY7jv8s_0 'Play video "Pterodactyl Panel Installation Guide [Quick and Easy]"')

Video can't be loaded because JavaScript is disabled: [Pterodactyl Panel Installation Guide \[Quick and Easy\] (https://www.youtube.com/watch?v=UVDY7jv8s_0)](https://www.youtube.com/watch?v=UVDY7jv8s_0 "Pterodactyl Panel Installation Guide [Quick and Easy]")
...
<Image
  ...
  width="1718"
  height="1287"
  alt="vultr screenshot"
  sizes="(max-width: 1718px) 100vw, 1718px"
  src={__vultr_screenshot_minecraft_vps_png}
  widths={[1718, 300, 1024, 768, 1536]}
/>
...
<Image
  ...
  width="1274"
  height="1026"
  alt="select server and location"
  sizes="(max-width: 1274px) 100vw, 1274px"
  src={__select_server_and_location_png}
  widths={[1274, 300, 1024, 768]}
/>
...
<Image
  ...
  width="1248"
  height="984"
  alt="vultr select server for pterodactyl"
  sizes="(max-width: 1248px) 100vw, 1248px"
  src={__vultr_select_server_for_pterodactyl_png}
  widths={[1248, 300, 1024, 768]}
/>
...
<Image
  ...
  src={__vultr_hostname_png}
  widths={[1297, 300, 1024, 768]}
/>
...
<Image
  ...
  width="1380"
  height="300"
  alt="server running on vultr and pterodactyl"
  sizes="(max-width: 1380px) 100vw, 1380px"
  src={__server_running_on_vultr_and_pterodactyl_png}
  widths={[1380, 300, 1024, 768]}
/>
...
<Image
  ...
  width="1262"
  height="556"
  alt="access ssh vultr"
  sizes="(max-width: 1262px) 100vw, 1262px"
  src={__access_ssh_vultr_png}
  widths={[1262, 300, 1024, 768]}
/>
...
<Image
  ...
  src={__vultr_terminal_png}
  widths={[1050, 300, 1024, 768]}
/>
...
<Image
  ...
  width="1047"
  height="455"
  alt="pterodactyl script install"
  sizes="(max-width: 1047px) 100vw, 1047px"
  src={__pterodactyl_script_install_png}
  widths={[1047, 300, 1024, 768]}
/>
...
<Image
  ...
  width="1047"
  height="764"
  alt="pterodactyl wings and panel install"
  sizes="(max-width: 1047px) 100vw, 1047px"
  src={__pterodactyl_wings_and_panel_install_png}
  widths={[1047, 300, 1024, 768]}
/>
...
<Image
  ...
  width="897"
  height="522"
  alt="pterodactyl login page"
  sizes="(max-width: 897px) 100vw, 897px"
  src={__pterodactyl_login_page_png}
  widths={[897, 300, 768]}
/>
