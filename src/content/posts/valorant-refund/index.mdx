...
import __Open_the_Valorant_support_website_jpg from "./Open-the-Valorant-support-website.jpg";
import __Click_Get_My_Order_History_jpg from "./Click-Get-My-Order-History.jpg";
import __select_the_valorant_skin_to_refund_jpg from "./select-the-valorant-skin-to-refund.jpg";
...
<Image decoding="async" width="1701" height="1262" alt="TODO: update alt text" sizes="(max-width: 1701px) 100vw, 1701px" src={__Open_the_Valorant_support_website_jpg} widths={[1701, 768, 1536]} />
...
<Image decoding="async" width="1537" height="771" alt="Click Get My Order History" sizes="(max-width: 1537px) 100vw, 1537px" src={__Click_Get_My_Order_History_jpg} widths={[1537, 768]} />

At the bottom of the page click "Get My Order History"

### 3\. Select the item you want to refund

<Image decoding="async" width="990" height="541" alt="TODO: update alt text" sizes="(max-width: 990px) 100vw, 990px" src={__select_the_valorant_skin_to_refund_jpg} widths={[990, 768]} />
...
Video can't be loaded because JavaScript is disabled: [HOW TO REFUND SKINS IN VALORANT \[2021\] (https://www.youtube.com/watch?v=RbUpxdXx0l8)](https://www.youtube.com/watch?v=RbUpxdXx0l8 "HOW TO REFUND SKINS IN VALORANT [2021]")
