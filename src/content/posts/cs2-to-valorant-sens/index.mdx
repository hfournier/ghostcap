...
import __how_to_find_mouse_sensitivty_csgo_jpg from "./how-to-find-mouse-sensitivty-csgo.jpg";
import __csgo_console_sensitivity_jpg from "./csgo-console-sensitivity.jpg";
import __valo_sens_convertor_2160x1210_png from "./valo-sens-convertor-2160x1210.png";
import __valorant_patch_jpg from "./valorant-patch.jpg";
import __csgo_and_valo_esports_jpg from "./csgo-and-valo-esports.jpg";
...
<Image decoding="async" width="1280" height="800" alt="TODO: update alt text" sizes="(max-width: 1280px) 100vw, 1280px" src={__how_to_find_mouse_sensitivty_csgo_jpg} widths={[1280, 768]} />
...
<Image decoding="async" width="1280" height="800" alt="TODO: update alt text" sizes="(max-width: 1280px) 100vw, 1280px" src={__csgo_console_sensitivity_jpg} widths={[1280, 768]} />
...
<Image decoding="async" width="2160" height="1210" alt="TODO: update alt text" sizes="(max-width: 2160px) 100vw, 2160px" src={__valo_sens_convertor_2160x1210_png} widths={[2160, 768, 1536, 2048, 2555]} />
...
<Image decoding="async" width="1000" height="667" alt="TODO: update alt text" sizes="(max-width: 1000px) 100vw, 1000px" src={__valorant_patch_jpg} widths={[1000, 768]} />
...
<Image decoding="async" width="1400" height="733" alt="TODO: update alt text" sizes="(max-width: 1400px) 100vw, 1400px" src={__csgo_and_valo_esports_jpg} widths={[1400, 768]} />
