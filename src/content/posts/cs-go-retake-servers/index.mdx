...
<Image decoding="async" width="730" height="325" alt="Best CS GO Hide and Seek Servers" sizes="(max-width: 730px) 100vw, 730px" src={__Best_CS_GO_Hide_and_Seek_Servers_png} widths={[730, 300]} />
