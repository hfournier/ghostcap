...
<Image decoding="async" width="730" height="325" alt="Cybershoke CSGO Deathmatch" sizes="(max-width: 730px) 100vw, 730px" src={__Cybershoke_CSGO_Deathmatch_png} widths={[730, 300]} />
...
<Image decoding="async" width="730" height="325" alt="Warmup Server" sizes="(max-width: 730px) 100vw, 730px" src={__Warmup_Server_png} widths={[730, 300]} />
