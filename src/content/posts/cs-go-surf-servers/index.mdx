...
import __ghostcap_cs_go_surf_server_png from "./ghostcap-cs-go-surf-server.png";
import __surf_haven_server_csgo_png from "./surf-haven-server-csgo.png";
import __KSF_Clan_Surf_png from "./KSF-Clan-Surf.png";
import __surf_utopia_server_png from "./surf-utopia-server.png";
...
<Image
  ...
  width="730"
  height="325"
  alt="ghostcap cs go surf server"
  sizes="(max-width: 730px) 100vw, 730px"
  src={__ghostcap_cs_go_surf_server_png}
  widths={[730, 300]}
/>
...
The server also offers plenty of fun and surf maps so come on over today and start playing on our surf servers today.
...
<Image
  ...
  width="730"
  height="325"
  alt="surf haven server csgo"
  sizes="(max-width: 730px) 100vw, 730px"
  src={__surf_haven_server_csgo_png}
  widths={[730, 300]}
/>
...
<Image
  ...
  width="730"
  height="325"
  alt="surf utopia server"
  sizes="(max-width: 730px) 100vw, 730px"
  src={__surf_utopia_server_png}
  widths={[730, 300]}
/>
...
![](Best-Surf-Maps-For-Beginners.webp)
...
- surf_rookie
- surf_kitsune (The best surfing map)
- surf_beginner
- surf_rebel
- surf_utopia_v3
- surf_mesa
