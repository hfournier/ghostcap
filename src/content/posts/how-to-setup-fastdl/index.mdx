...
import __custom_content_source_game_fastdl_jpg from "./custom-content-source-game-fastdl.jpg";
import __DreamHost_Web_Panel_Users_Files_jpg from "./DreamHost-Web-Panel-Users-Files.jpg";
import __fastdl_FTP_jpg from "./fastdl-FTP.jpg";
import __fastdl_FTP_after_folders_are_created_jpg from "./fastdl-FTP-after-folders-are-created.jpg";
import __fastdl_example_jpg from "./fastdl-example.jpg";
...
<Image decoding="async" width="1366" height="768" alt="TODO: update alt text" sizes="(max-width: 1366px) 100vw, 1366px" src={__custom_content_source_game_fastdl_jpg} widths={[1366, 768]} />
...
<Image decoding="async" width="1328" height="434" alt="DreamHost-Web-Panel-Users-Files" sizes="(max-width: 1328px) 100vw, 1328px" src={__DreamHost_Web_Panel_Users_Files_jpg} widths={[1328, 768]} />
...
<Image decoding="async" width="1231" height="855" alt="TODO: update alt text" sizes="(max-width: 1231px) 100vw, 1231px" src={__fastdl_FTP_jpg} widths={[1231, 768]} />
...
<Image decoding="async" width="1231" height="856" alt="fastdl FTP after folders are created" sizes="(max-width: 1231px) 100vw, 1231px" src={__fastdl_FTP_after_folders_are_created_jpg} widths={[1231, 768]} />
...
<Image decoding="async" width="1592" height="898" alt="fastdl example" sizes="(max-width: 1592px) 100vw, 1592px" src={__fastdl_example_jpg} widths={[1592, 768, 1536]} />
