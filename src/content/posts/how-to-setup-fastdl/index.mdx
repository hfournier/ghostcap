...
<Image
  ...
  src={__custom_content_source_game_fastdl_jpg}
  widths={[1366, 768]}
/>
...
Setting up a FastDL is quite simple and is the same for most source games. For this example, I'm going to be using CSGO, uploading a custom map called bhop_y.bsp, and [ranks for a Faceit levels plugin](https://forums.alliedmods.net/showthread.php?t=324610).
...
<Image
  ...
  width="1328"
  height="434"
  alt="DreamHost-Web-Panel-Users-Files"
  sizes="(max-width: 1328px) 100vw, 1328px"
  src={__DreamHost_Web_Panel_Users_Files_jpg}
  widths={[1328, 768]}
/>
...
<Image
  ...
  width="1231"
  height="856"
  alt="fastdl FTP after folders are created"
  sizes="(max-width: 1231px) 100vw, 1231px"
  src={__fastdl_FTP_after_folders_are_created_jpg}
  widths={[1231, 768]}
/>
...
So for the map, we need to create a folder on the Fastdl called maps, and I'm going to upload the map bhop_y.bsp to the folder.
...
![Game-Host-Bros-My-CSGO-Server-Edit-File](Game-Host-Bros-My-CSGO-Server-Edit-File.jpg)
...
<Image
  ...
  src={__fastdl_example_jpg}
  widths={[1592, 768, 1536]}
/>
